...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");f(t,e,function(e,t){n(t)},r)}))}),p)}(),e.exports&&(e.exports=N[t]),n.exports),A=new WeakMap;/**
...
}),R(this,"event:".concat(e),t)}},{key:"off",value:function(e,t){if(!e)throw TypeError("You must pass an event name.");if(t&&"function"!=typeof t)throw TypeError("The callback must be a function.");q(this,"event:".concat(e),t)&&this.callMethod("removeEventListener",e).catch(function(e){// Ignore the error. There will be an error event fired that
// will trigger the error callback if they are listening.
 ...
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;window.VimeoSeoMetadataAppended||(window.VimeoSeoMetadataAppended=!0,window.addEventListener("message",function(t){if(O(t.origin)){var n=V(t.data);if(n&&"ready"===n.event)for(var r=e.querySelectorAll("iframe"),o=0;o<r.length;o++){var i=r[o],a=i.contentWindow===t.source;_(i.src)&&a&&new J(i).callMethod("appendVideoMetadata",window.location.href)}}}))}(),/**
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=eh(t)||0,ed(n)&&(s=!!n.leading,i=(f="maxWait"in n)?el(eh(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(ef())},m}(e,t,{leading:r,maxWait:t,trailing:o})};var ep=document.querySelector("iframe"),ev=new J(ep,{id:236203659,width:640,loop:!0});ev.on("timeupdate",((a=X)&&a.__esModule?a.default:a)(function(e){var t=e.seconds;localStorage.setItem("videoplayer-current-time",t)},1e3)),ev.setCurrentTime(localStorage.getItem("videoplayer-current-time")||0)}();//# sourceMappingURL=02-video.f9f3be57.js.map

//# sourceMappingURL=02-video.f9f3be57.js.map
